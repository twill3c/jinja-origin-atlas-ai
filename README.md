...
| ✅ | **祭神の三面**(`/deity`): 共祀ネットワーク・県別リフトの点地図・習合の対応表。一柱を選ぶと三面が同時に変わる。**登録した予測は二つとも測って落ちた** —— リフト最上位の県が総本社の県と一致したのは 26 柱中 7 柱(合格線 13)、同一視を共起の強さから当てる適合率は 0.625(合格線 0.70)。落ちたことを画面に書いている |
